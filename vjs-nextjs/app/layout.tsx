...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Engineering Smart Automation for Modern Industries — PLC, SCADA, IoT, Wireless Monitoring & Robotics.",
  },
  twitter: {
    card: "summary_large_image",
    title: "VJS Smart Systems",
    description: "Engineering Smart Automation for Modern Industries.",
  },
