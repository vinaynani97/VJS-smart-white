          ...
          <Reveal className="lg:col-span-7" delay={0.15}>
            <div className="border border-ink-800 bg-ink-900/40">
              <div className="p-8 border-b border-ink-800">
                ...
                <h3 className="font-display text-2xl lg:text-3xl font-medium tracking-tight mt-3">Tell us about your project</h3>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={onSubmit} data-testid="contact-form" className="p-8 grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <Field name="product_interest" label="Product / Service Interested In" value={form.product_interest} onChange={onChange} className="md:col-span-2" />
                  <Field name="project_requirement" label="Project Requirement" value={form.project_requirement} onChange={onChange} className="md:col-span-2" />
                  ...
                  <div className="md:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:justify-between pt-4 border-t border-ink-800">
                    <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-ink-500">We respond within 1 business day</p>
                    <button
