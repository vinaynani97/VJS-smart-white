  ...
  return (
    <div data-testid="not-found-page" className="relative min-h-[70vh] grid place-items-center overflow-hidden">
      ...
      <div className="relative text-center max-w-xl px-6">
        ...
        <p className="text-lg text-ink-300 mt-6">The page you&apos;re looking for has gone offline. Let&apos;s reroute you.</p>
        <Link href="/" className="group inline-flex items-center gap-2 mt-10 bg-signal-500 hover:bg-signal-600 text-white px-7 py-4 text-xs font-mono uppercase tracking-[0.2em]">
          Back to homepage <ArrowUpRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
        </Link>
      </div>
    </div>
  );
