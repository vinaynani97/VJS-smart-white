...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "VJS Smart Systems is a technology-driven engineering company specializing in Industrial Automation, IoT Monitoring, Control Panels, Robotics, and Industry 4.0 Solutions.",
};

const ICONS: LucideIcon[] = [ShieldCheck, Users, Target, Sparkles, Eye];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-end">
            ...
            <div className="lg:col-span-5 lg:col-start-8">
              <Image
                ...
                width={800}
                height={450}
                className="w-full aspect-[16/9] object-cover border border-ink-800"
              />
            </div>
          </div>
      ...
      <section className="border-t border-ink-800/80 bg-ink-900/30">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          ...
          <Link
            ...
            className="group inline-flex items-center gap-2 bg-signal-500 hover:bg-signal-600 text-white px-8 py-5 text-xs font-mono uppercase tracking-[0.2em] shrink-0"
          >
