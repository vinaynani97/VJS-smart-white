        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-12 gap-x-8 py-16">
          <div className="col-span-2 md:col-span-4">
            ...
            <div className="flex items-center gap-2 mt-6">
              {([Linkedin, Twitter, Youtube] as const).map((Icon, i) => (
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={link.l}>
                  <Link href={link.to} className="text-ink-200 hover:text-signal-500 transition-colors">{link.l}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-sm">
              {SERVICES.slice(0, 5).map((s) => (
                <li key={s.id}>
                  <Link href="/products" className="text-ink-200 hover:text-signal-500 transition-colors">{s.title}</Link>
                </li>
              ))}
            </ul>
          </div>
